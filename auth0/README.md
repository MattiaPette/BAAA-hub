...
# This directory contains Auth0 configuration files managed via the Auth0 Deploy CLI.

# Configuration is managed as Infrastructure as Code (IaC) to ensure:
...
# - `API_URL`: Backend webhook URL (e.g., `https://api.your-app.com/api/webhooks/auth0/user-update`)
